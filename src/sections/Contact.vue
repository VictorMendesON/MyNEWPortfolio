...
<template>
    <transition name="fade" mode="in-out">
        <Toast v-if="showToast" :message="'Thank You, for your message! I will get back to you shortly.'" @close="handleClose"/>
    </transition>
    ...
    <section id="contact" class="relative py-28 lg:py-36 overflow-hidden">
        ...
        <div class="container px-3 mx-auto max-w-6xl 2xl:max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 dark:text-slate-300 tracking-wide">
                <div class="md:col-span-5">
                    ...
                    <div id="link-whatsapp">
                        <p class="text-lg text-slate-600 dark:text-slate-300">
                            ...
                            <a href="https://wa.me/5521980605911" target="_blank" rel="noopener noreferrer" class="ml-2 underline text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 cursor-pointer transition-colors duration-300">{{ t("Click here") }}</a>
                        </p>
                    </div>
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center space-x-4" id="email">
                            <div>
                            ...
                            <div>
                                ...
                                <p><a href="mailto:victormendesdevv@gmail.com" class="transition-all duration-300 hover:text-secondary-500 dark:hover:text-secondary-300">victormendesdevv@gmail.com</a></p>
                            </div>
                        </li>
                        <li class="flex items-center space-x-4" id="social-media">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 dark:text-primary-300 text-primary-500">
                        ...
                        <li class="flex items-center space-x-4" id="location">
                            <div>
                            ...
                            <div>
                                ...
                                <p><a href="https://www.google.com/maps/place/Dhaka/@23.7809757,90.3372882,12z/" target="_blank"class="transition-all duration-300 hover:text-secondary-500 dark:hover:text-secondary-300">{{ t ('Brazil, Rio de Janeiro') }}</a>
                                </p>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="md:col-span-7" id="formulario">
                    <form @submit.prevent="submitContactForm" class="grid grid-cols-2 gap-x-6 gap-y-8">
                        <div class="col-span-2 md:col-span-1 flex flex-col space-y-3">
                            ...
                            <InputField v-model="contactForm.name" type="text" id="name" name="name" :placeholder="t('form.namePlaceholder')" :error="contactFormErrors.name"/>
                        ...
                        <div class="col-span-2 md:col-span-1 flex flex-col space-y-3">
                            ...
                            <InputField v-model="contactForm.email" type="text" id="email" name="email" :placeholder="t ('form.emailPlaceholder')" :error="contactFormErrors.email"/>
                        ...
                        <div class="col-span-2 flex flex-col space-y-3">
                            ...
                            <InputField v-model="contactForm.subject" type="text" id="subject" name="subject" :placeholder="t('form.subjectPlaceholder')":error="contactFormErrors.subject"/>
                        ...
                        <div class="col-span-2 flex flex-col space-y-3">
                            ...
                            />
                            <TextArea v-model="contactForm.message" id="message" class="h-40" name="name" :placeholder="t('form.messagePlaceholder')" :error="contactFormErrors.message"/>
