...
<template>
    <section id="contact" class="relative py-28 lg:py-36 overflow-hidden">
        ...
        ></div>
        <div
            class="absolute right-[28%] top-0 h-[150px] w-[200px] rotate-12 rounded-3xl bg-gradient-to-l from-teal-600 to-teal-400 blur-3xl filter block opacity-30 dark:opacity-10 lg:top-44 lg:-right-20 lg:h-72 lg:w-[350px] xl:h-80 xl:w-[500px] md:hidden"
        ></div>
        <div class="container px-3 mx-auto max-w-6xl 2xl:max-w-7xl">
            <SectionHeading>{{ t('Get In Touch') }}</SectionHeading>

            <div
                class="grid grid-cols-1 md:grid-cols-12 gap-10 dark:text-slate-300 tracking-wide p-10 md:p-10"
            >
                <div class="md:col-span-5">
                    ...
                    <p class="text-lg text-slate-600 dark:text-slate-300">
                        ...
                        <a
                            href="https://wa.me/5521980605911"
                            target="_blank"
                            class="ml-2 underline text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
                        >
                            {{ t('Click Here') }}
                        </a>
                    </p>
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p>
                                    <a
                                        href="mailto:victormendesdevv@gmail.com"
                                        class="hover:text-secondary-500"
                                        >victormendesdevv@gmail.com</a
                                    >
                                </p>
                            </div>
                        </li>
                        ...
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p>
                                    <a
                                        href="https://www.google.com/maps/place/Rio+de+Janeiro/"
                                        target="_blank"
                                        class="hover:text-secondary-500"
                                    >
