    ...
    <header class="py-5 md:py-7 sticky top-0 z-40 shadow backdrop-blur-2xl bg-slate-200/80 dark:bg-[#0B1120]/80">
        <nav class="container mx-auto px-3 max-w-6xl 2xl:max-w-7xl flex justify-center items-center">
            <ul v-scroll-spy-active="{ selector: 'li a.menu-link-1', class: 'active-link' }" class="hidden md:flex space-x-12">
                <li><NavLink :link="'#home'">{{ t ('Home')}}</NavLink></li>
                <li><NavLink :link="'#about'">{{ t ('About')}}</NavLink></li>
                <li><NavLink :link="'#works'">{{ t ('Works')}}</NavLink></li>
                <li><NavLink :link="'#contact'">{{ t ('Contact')}}</NavLink></li>
